  ...
  return (
    <Modal visible={visible} animationType="slide" statusBarTranslucent onRequestClose={onClose}>
      <View style={styles.root}>
        ...
        {/* ── Top bar ── */}
        <SafeAreaView
          style={[styles.topBar, Platform.OS === "android" && styles.topBarAndroid]}
        >
